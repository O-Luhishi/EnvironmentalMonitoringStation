...
public abstract class Log_of_alarm_readingsHelper
{
	...
	{
		return "IDL:ClientAndServer/Log_of_alarm_readings:1.0";
	}
	public static ClientAndServer.NoxReading[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new ClientAndServer.NoxReading[_l_result0];
