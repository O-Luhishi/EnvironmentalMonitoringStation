...
public class _HeadQuarterStub
	...
	implements ClientAndServer.HeadQuarter
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = ClientAndServer.HeadQuarterOperations.class;
	public java.lang.String getNox()
	{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getNox", _opsClass );
			if( _so == null )
				continue;
	...
	public void connectLMS()
	{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "connectLMS", _opsClass );
			if( _so == null )
				continue;
			HeadQuarterOperations _localServant = (HeadQuarterOperations)_so.servant;
			try
			{
				_localServant.connectLMS();
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
		...
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					...
					ClientAndServer.NoxReadingHelper.write(_os,alarm_reading);
					_is = _invoke(_os);
					return;
				}
				catch( org.omg.CORBA.portable.RemarshalException _rx )
	...
	public java.lang.String noxReading_ToString(ClientAndServer.NoxReading reading)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "noxReading_ToString", true);
					ClientAndServer.NoxReadingHelper.write(_os,reading);
					_is = _invoke(_os);
					java.lang.String _result = _is.read_string();
					return _result;
				}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "noxReading_ToString", _opsClass );
			if( _so == null )
				continue;
			HeadQuarterOperations _localServant = (HeadQuarterOperations)_so.servant;
			java.lang.String _result;
			try
			{
				_result = _localServant.noxReading_ToString(reading);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return _result;
			}
...
_os.write_string( tmpResult10 );
					java.lang.String tmpResult11 = contact_details;
_os.write_string( tmpResult11 );
					java.lang.String tmpResult12 = area_of_interest;
